...
class TMSocialLoginFacebookLoginModuleFrontController extends ModuleFrontController
{
	public function initContent()
	{
		...
		$this->login_url = $this->context->link->getModuleLink('tmsociallogin', 'facebooklogin',
																array('back' => $back), true, $this->context->language->id);
		...
		if ($user_id)
		{
			...
			if (empty($useremail))
			{
				...
				{
					Tools::redirect($this->context->link->getModuleLink('tmsociallogin', 'facebookregistration',
									array(
										'user_id' => $user_id,
										'user_name' => $user_name,
										'email' => $user_email,
				...
				{
					Tools::redirect($this->context->link->getModuleLink('tmsociallogin', 'facebooklink',
									array(
										'user_id' => $user_id,
										'user_name' => $user_name,
										'email' => $user_email,
