<div id="header-login">
    ...
    <div class="current header_user_info"><a href="#" onclick="return false;">{if $is_logged}{l s='' mod='tmheaderaccount'}{else}{l s='' mod='tmheaderaccount'}{/if}</a></div>
                ...
                <form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="header_login_form">
                    ...
                    <div class="form_content clearfix">
                        <div class="form-group">
                            <label for="email">{l s='Email address' mod='tmheaderaccount'}</label>
                        ...
                        <div class="form-group">
                            <label for="passwd">{l s='Password' mod='tmheaderaccount'}</label>
