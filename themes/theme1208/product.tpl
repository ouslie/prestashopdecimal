...
<div itemscope itemtype="http://schema.org/Product">
    <div class="primary_block row{if $columns == 2} two-columns{elseif $columns == 3} three-columns{else} one-column{/if}">	
        ...
        {/if}
                ...
                <!-- center infos -->
                <div class="pb-right-column {if $columns == 2}col-xs-12 col-md-5 col-lg-6{elseif $columns == 3}col-xs-12 {elseif $content_only} col-xs-5{else}col-sm-6 col-md-6 col-lg-6{/if}">
